...
export const ProductList = ({ product, itemInCart, itemInFav }) => {
  ...
  return (
    <li className=' bg-gray-900 p-3 rounded-md grid gap-4 shadow-md shadow-slate-700' key={id}>
      ...
      <section className='flex gap-3'>
        ...
        <Link className='rounded-md border-2 bg-zinc-400 border-zinc-400 p-2 flex items-center w-2/5 hover:bg-zinc-600 transition-all hover:scale-95' to={`/product/${title}`}>More <ExternalLink />
        </Link>
      </section>
    </li>
  )
